      ...
      <main className="pt-24 pb-20">
        <article className="container mx-auto px-4 max-w-3xl">
          ...
          <div className="prose prose-lg mt-8 font-body text-muted-foreground leading-relaxed space-y-6">
            ...
            <p>Desarmamos todos los muebles que sea necesario para facilitar su traslado — placares, camas, bibliotecas, escritorios — y los volvemos a armar en el nuevo hogar. Nuestros operarios están capacitados para manejar muebles de todo tipo, incluyendo muebles a medida y sistemas de placares.</p>

            <h2 className="font-display text-2xl font-bold text-foreground mt-10 mb-4">Carga y transporte</h2>
            <p>Contamos con una flota propia de camiones de distintos tamaños, desde utilitarios para mudanzas pequeñas hasta camiones de gran capacidad para casas completas. Todos nuestros vehículos están en perfectas condiciones y cuentan con el equipamiento necesario para proteger tus pertenencias durante el viaje.</p>
