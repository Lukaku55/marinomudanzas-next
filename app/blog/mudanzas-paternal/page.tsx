      ...
      <main className="pt-24 pb-20">
        <article className="container mx-auto px-4 max-w-3xl">
          ...
          <div className="prose prose-lg mt-8 font-body text-muted-foreground leading-relaxed space-y-6">
            ...
            <p>Paternal es uno de los barrios más tranquilos de CABA en cuanto a tráfico, lo que fácilita mucho las operaciónes de mudanza. Predominan las casas de familia con jardín y los edificios bajos de 3 a 5 pisos. Las calles son amplias en los ejes principales y más angostas en el interior del barrio.</p>
            <ul className="list-disc pl-6 space-y-2">
              <li>Predominio de casas bajas y edificios de poca altura</li>
              <li>Calles tranquilas con poco tráfico — fácilita la carga y descarga</li>
            ...
            <h2 className="font-display text-2xl font-bold text-foreground mt-10 mb-4">Contactános para tu mudanza en Paternal</h2>
