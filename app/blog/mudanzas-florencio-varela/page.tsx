...
export const metadata: Metadata = {
  title: "Mudanzas en Florencio Varela GBA | Marino Mudanzas Buenos Aires",
  description: "Mudanzas en Florencio Varela con más de 80 años de experiencia. Cubrimos todo el partido del sur del GBA. Embalaje incluido y presupuesto sin cargo. Tel 4611-1818",
};
    ...
    <>
      ...
      <main className="pt-24 pb-20">
        <article className="container mx-auto px-4 max-w-3xl">
          ...
          <h1 className="font-display text-3xl md:text-5xl font-bold text-foreground mb-4">Mudanzas en Florencio Varela</h1>
          <div className="prose prose-lg mt-8 font-body text-muted-foreground leading-relaxed space-y-6">
            <p>Florencio Varela es un partido del sur del Gran Buenos Aires en constante crecimiento. Con una población numerosa y una fisonomía predominantemente residencial, es un destino cada vez más frecuente para mudanzas desde y hacia la Ciudad de Buenos Aires. En Marino Mudanzas realizamos mudanzas en Florencio Varela con más de 80 años de experiencia.</p>

            <h2 className="font-display text-2xl font-bold text-foreground mt-10 mb-4">Características de las mudanzas en Florencio Varela</h2>
            <p>Florencio Varela tiene una fisonomía predominantemente horizontal con casas de familia en barrios residenciales. La conexión con CABA se realiza principalmente por la Autopista Buenos Aires-La Plata y rutas provinciales.</p>
            <ul className="list-disc pl-6 space-y-2">
              ...
              <li>Localidades: Florencio Varela Centro, Bosques, Villa Brown, Ingeniero Allan</li>
            </ul>

            <h2 className="font-display text-2xl font-bold text-foreground mt-10 mb-4">Nuestro servicio de mudanzas en Florencio Varela</h2>
            <ul className="list-disc pl-6 space-y-2">
            ...
            <h2 className="font-display text-2xl font-bold text-foreground mt-10 mb-4">Cobertura en Florencio Varela</h2>
            <p>Cubrimos todo el partido de Florencio Varela incluyendo Florencio Varela Centro, Bosques, Villa Brown, Ingeniero Allan y todas las localidades del partido.</p>

            <h2 className="font-display text-2xl font-bold text-foreground mt-10 mb-4">Preguntas frecuentes sobre mudanzas en Florencio Varela</h2>
            ...
            <h3 className="font-display text-xl font-semibold text-foreground mt-6 mb-2">¿El precio incluye la descarga en Florencio Varela?</h3>
            ...
            <ul className="list-disc pl-6 space-y-2">
              <li><a href="/blog/mudanzas-berazategui" className="text-gold hover:underline">Mudanzas en Berazategui</a></li>
            ...
            <h2 className="font-display text-2xl font-bold text-foreground mt-10 mb-4">Contactános para tu mudanza en Florencio Varela</h2>
