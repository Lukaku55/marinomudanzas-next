      ...
      <main className="pt-24 pb-20">
        <article className="container mx-auto px-4 max-w-3xl">
          ...
          <div className="prose prose-lg mt-8 font-body text-muted-foreground leading-relaxed space-y-6">
            ...
            <p>Versalles tiene una fisonomía única en Buenos Aires — sus calles curvas y sinuosas, el predominio de casas con jardín de alto nivel y la tranquilidad del barrio hacen que las mudanzas requieran una planificación especial para el acceso de los camiones.</p>
            ...
            <h2 className="font-display text-2xl font-bold text-foreground mt-10 mb-4">Contactanos para tu mudanza en Versalles</h2>
