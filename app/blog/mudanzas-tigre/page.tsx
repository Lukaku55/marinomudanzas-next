...
export const metadata: Metadata = {
  ...
  description: "Servicio de mudanzas en Tigre, Nordelta y countries del partido. Mas de 80 anos de experiencia. Presupuesto sin cargo. Tel 4611-1818",
};
      ...
      <main className="pt-24 pb-20">
        <article className="container mx-auto px-4 max-w-3xl">
          ...
          <div className="prose prose-lg mt-8 font-body text-muted-foreground leading-relaxed space-y-6">
            ...
            <h3 className="font-display text-xl font-semibold text-foreground mt-6 mb-2">Pueden ingresar a Nordelta con el camion de mudanzas?</h3>
            <p>Si, coordinamos el acceso con la administracion de Nordelta previamente. Conocemos los requisitos y horarios permitidos para el ingreso de camiones de mudanza.</p>
