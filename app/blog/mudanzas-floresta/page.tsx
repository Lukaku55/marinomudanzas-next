      ...
      <main className="pt-24 pb-20">
        <article className="container mx-auto px-4 max-w-3xl">
          ...
          <div className="prose prose-lg mt-8 font-body text-muted-foreground leading-relaxed space-y-6">
            ...
            <p>Floresta tiene una fisonomía similar a la de Flores — predominio de casas bajas con jardín y edificios de 4 a 6 pisos. Las calles son tranquilas y arboladas, lo que facilita mucho las operaciones de mudanza. Es uno de los barrios donde más trabajamos dada nuestra cercanía.</p>
