...
export const metadata: Metadata = {
  title: "Mudanzas en Moreno GBA | Marino Mudanzas Buenos Aires",
  description: "Mudanzas en Moreno con más de 80 años de experiencia. Servicio desde Buenos Aires a todo el partido de Moreno. Embalaje incluido y presupuesto sin cargo. Tel 4611-1818",
};
      ...
      <main className="pt-24 pb-20">
        <article className="container mx-auto px-4 max-w-3xl">
          ...
          <div className="prose prose-lg mt-8 font-body text-muted-foreground leading-relaxed space-y-6">
            <p>Moreno es un partido del oeste del Gran Buenos Aires con una población en constante crecimiento. Con una gran variedad de barrios desde zonas urbanas densas hasta countries y barrios privados, la demanda de mudanzas es muy alta. En Marino Mudanzas realizamos mudanzas en Moreno con más de 80 años de experiencia.</p>

            <h2 className="font-display text-2xl font-bold text-foreground mt-10 mb-4">Características de las mudanzas en Moreno</h2>
            <p>Moreno tiene una fisonomía muy variada — desde zonas urbanas con edificios hasta grandes barrios privados y countries en la periferia. Dependiendo de la zona del partido, las distancias desde CABA pueden variar entre 30 y 50 km.</p>
            <ul className="list-disc pl-6 space-y-2">
              <li>Partido con alta variedad de zonas — urbanas, countries y barrios cerrados</li>
              <li>Buena conexión por Autopista del Oeste y Acceso Oeste</li>
              <li>Fuerte crecimiento poblacional con alta demanda de mudanzas</li>
              <li>Localidades: Moreno, Francisco Álvarez, La Reja, Cuartel V</li>
            </ul>

            <h2 className="font-display text-2xl font-bold text-foreground mt-10 mb-4">Nuestro servicio de mudanzas en Moreno</h2>
            <ul className="list-disc pl-6 space-y-2">
            ...
            <h2 className="font-display text-2xl font-bold text-foreground mt-10 mb-4">Cobertura en Moreno</h2>
            <p>Cubrimos todo el partido de Moreno incluyendo Moreno Centro, Francisco Álvarez, La Reja, Cuartel V y todas las localidades del partido.</p>
            ...
            <h3 className="font-display text-xl font-semibold text-foreground mt-6 mb-2">¿El precio incluye la descarga en Moreno?</h3>
            ...
            <h2 className="font-display text-2xl font-bold text-foreground mt-10 mb-4">Contactános para tu mudanza en Moreno</h2>
