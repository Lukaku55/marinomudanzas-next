...
const articles = [
  ...
  {slug:'mudanzas-pilar',title:'Mudanzas en Pilar GBA',excerpt:'Servicio de mudanzas en Pilar. Manuel Alberti, Del Viso, Fátima y todo el partido del norte del GBA. Presupuesto sin cargo.',date:'2026-04-23'},
