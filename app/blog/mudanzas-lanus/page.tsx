...
export const metadata: Metadata = {
  ...
  description: "Servicio de mudanzas en Lanus Este, Lanus Oeste y Remedios de Escalada. Mas de 80 años de experiencia. Presupuesto sin cargo. Tel 4611-1818",
};
...
const jsonLd = {
  ...
  "@type": "Article",
  "headline": "Mudanzas en Lanus GBA | Marino Mudanzas Buenos Aires",
  "description": "Servicio de mudanzas en Lanus Este, Lanus Oeste y Remedios de Escalada. Mas de 80 años de experiencia. Presupuesto sin cargo. Tel 4611-1818",
      ...
      <main className="pt-24 pb-20">
        <article className="container mx-auto px-4 max-w-3xl">
          ...
          <div className="prose prose-lg mt-8 font-body text-muted-foreground leading-relaxed space-y-6">
            <p>Lanus es uno de los partidos mas poblados del sur del Gran Buenos Aires, con una gran cantidad de departamentos y casas de familia. En Marino Mudanzas realizamos mudanzas en Lanus Este, Lanus Oeste y Remedios de Escalada con la precision y el cuidado que nos caracteriza hace más de 80 anos.</p>
