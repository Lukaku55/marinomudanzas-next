...
export const metadata: Metadata = {
  ...
  description: "Mudanzas en Barracas con más de 80 años de experiencia. Barrio histórico del sur de CABA. Embalaje incluido, seguro de carga y presupuesto sin cargo. Tel 4611-1818",
};
      ...
      <main className="pt-24 pb-20">
        <article className="container mx-auto px-4 max-w-3xl">
          ...
          <div className="prose prose-lg mt-8 font-body text-muted-foreground leading-relaxed space-y-6">
            <p>Barracas es uno de los barrios más históricos del sur de la Ciudad Autónoma de Buenos Aires. Con una mezcla de edificios de época, galpones reconvertidos en lofts y nuevos desarrollos residenciales, es un barrio que está creciendo rápidamente en demanda de mudanzas. En Marino Mudanzas realizamos mudanzas en Barracas con más de 80 años de experiencia en CABA.</p>

            <h2 className="font-display text-2xl font-bold text-foreground mt-10 mb-4">Características de las mudanzas en Barracas</h2>
            <p>Barracas tiene una fisonomía muy particular — conviven edificios históricos de gran valor arquitectónico, casas bajas, galpones reconvertidos y nuevas torres residenciales. Esto requiere experiencia para manejar distintos tipos de accesos y escaleras de época.</p>
            <ul className="list-disc pl-6 space-y-2">
              <li>Mezcla de edificios históricos, lofts y nuevas torres</li>
              <li>Escaleras de época en edificios antiguos — experiencia en accesos difíciles</li>
              <li>Galpones reconvertidos con accesos amplios pero poco convencionales</li>
              <li>Nuevos desarrollos con ascensores modernos y accesos estándar</li>
            </ul>

            <h2 className="font-display text-2xl font-bold text-foreground mt-10 mb-4">Nuestro servicio de mudanzas en Barracas</h2>
            <ul className="list-disc pl-6 space-y-2">
            ...
            <h2 className="font-display text-2xl font-bold text-foreground mt-10 mb-4">Zonas de Barracas donde operamos</h2>
            <p>Cubrimos todo el barrio de Barracas y las zonas limítrofes incluyendo Parque Patricios y La Boca. Las calles más frecuentes donde trabajamos incluyen Av. Montes de Oca, Av. Regimiento de Patricios, Av. Caseros y todo el interior del barrio.</p>
            ...
            <h3 className="font-display text-xl font-semibold text-foreground mt-6 mb-2">¿También hacen mudanzas desde Barracas hacia otros barrios o el GBA?</h3>
            ...
            <ul className="list-disc pl-6 space-y-2">
              ...
              <li><a href="/blog/mudanzas-boca" className="text-gold hover:underline">Mudanzas en La Boca</a></li>
            ...
            <h2 className="font-display text-2xl font-bold text-foreground mt-10 mb-4">Contactános para tu mudanza en Barracas</h2>
