...
export const metadata: Metadata = {
  title: "Mudanzas en General Rodríguez GBA | Marino Mudanzas Buenos Aires",
  description: "Mudanzas en General Rodríguez con más de 80 años de experiencia. Cubrimos todo el partido del oeste del GBA. Embalaje incluido y presupuesto sin cargo. Tel 4611-1818",
};
    ...
    <>
      ...
      <main className="pt-24 pb-20">
        <article className="container mx-auto px-4 max-w-3xl">
          ...
          <h1 className="font-display text-3xl md:text-5xl font-bold text-foreground mb-4">Mudanzas en General Rodríguez</h1>
          <div className="prose prose-lg mt-8 font-body text-muted-foreground leading-relaxed space-y-6">
            <p>General Rodríguez es un partido del oeste del Gran Buenos Aires con un perfil residencial en crecimiento. Con una buena conexión a través de la Autopista del Oeste y el ferrocarril Sarmiento, es un partido que atrae a familias que buscan espacios más amplios a precios accesibles. En Marino Mudanzas realizamos mudanzas en General Rodríguez con más de 80 años de experiencia.</p>

            <h2 className="font-display text-2xl font-bold text-foreground mt-10 mb-4">Características de las mudanzas en General Rodríguez</h2>
            <p>General Rodríguez tiene una fisonomía predominantemente horizontal con casas de familia y barrios residenciales en expansión. La Autopista del Oeste conecta eficientemente el partido con CABA.</p>
            <ul className="list-disc pl-6 space-y-2">
              <li>Partido en crecimiento con alta demanda de mudanzas</li>
              <li>Predominio de casas bajas y barrios residenciales</li>
              <li>Buena conexión por Autopista del Oeste y ferrocarril Sarmiento</li>
              <li>Destino popular para familias que buscan espacios amplios</li>
            </ul>

            <h2 className="font-display text-2xl font-bold text-foreground mt-10 mb-4">Nuestro servicio de mudanzas en General Rodríguez</h2>
            <ul className="list-disc pl-6 space-y-2">
            ...
            <h2 className="font-display text-2xl font-bold text-foreground mt-10 mb-4">Cobertura en General Rodríguez</h2>
            <p>Cubrimos todo el partido de General Rodríguez incluyendo General Rodríguez Centro y todas las localidades del partido.</p>

            <h2 className="font-display text-2xl font-bold text-foreground mt-10 mb-4">Preguntas frecuentes sobre mudanzas en General Rodríguez</h2>
            ...
            <h3 className="font-display text-xl font-semibold text-foreground mt-6 mb-2">¿El precio incluye la descarga en General Rodríguez?</h3>
            ...
            <ul className="list-disc pl-6 space-y-2">
              ...
              <li><a href="/blog/mudanzas-lujan" className="text-gold hover:underline">Mudanzas en Luján</a></li>
              <li><a href="/blog/mudanzas-moron" className="text-gold hover:underline">Mudanzas en Morón</a></li>
            </ul>

            <h2 className="font-display text-2xl font-bold text-foreground mt-10 mb-4">Contactános para tu mudanza en General Rodríguez</h2>
