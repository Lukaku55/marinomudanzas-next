      ...
      <main className="pt-24 pb-20">
        <article className="container mx-auto px-4 max-w-3xl">
          ...
          <div className="prose prose-lg mt-8 font-body text-muted-foreground leading-relaxed space-y-6">
            ...
            <p>Agronomía es uno de los barrios más tranquilos de CABA para operar una mudanza. Sus calles amplias, el bajo tráfico y el predominio de casas bajas facilitan mucho la logística. Es un barrio donde raramente hay problemas de acceso o estacionamiento para los camiones.</p>
            <ul className="list-disc pl-6 space-y-2">
              <li>Predominio absoluto de casas bajas con jardín</li>
              <li>Calles muy tranquilas con muy poco tráfico</li>
              <li>Amplio espacio para estacionamiento de camiones</li>
            ...
            <p>Sí, es el tipo de mudanza más frecuente en el barrio. Coordinamos el acceso por el frente o lateral según la disposición de la propiedad para facilitar la carga de muebles voluminosos.</p>
            ...
            <h2 className="font-display text-2xl font-bold text-foreground mt-10 mb-4">Contactanos para tu mudanza en Agronomía</h2>
