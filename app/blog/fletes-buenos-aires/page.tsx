...
export const metadata: Metadata = {
  ...
  description: "Servicio de fletes en Buenos Aires. Traslado de muebles, electrodomesticos y objetos en CABA y GBA. Mas de 80 anos de experiencia. Presupuesto sin cargo. Tel 4611-1818",
};
      ...
      <main className="pt-24 pb-20">
        <article className="container mx-auto px-4 max-w-3xl">
          ...
          <div className="prose prose-lg mt-8 font-body text-muted-foreground leading-relaxed space-y-6">
            ...
            <p>Contactanos por WhatsApp o teléfono y te damos un presupuesto sin cargo y sin compromiso. Trabajamos de lunes a sábado de 8 a 18hs.</p>
