...
export const metadata: Metadata = {
  ...
  description: "Servicio de mudanzas en Quilmes, Bernal, Berazategui y todo el partido. Mas de 80 años de experiencia. Presupuesto sin cargo. Tel 4611-1818",
};
...
const jsonLd = {
  ...
  "@type": "Article",
  "headline": "Mudanzas en Quilmes GBA | Marino Mudanzas Buenos Aires",
  "description": "Servicio de mudanzas en Quilmes, Bernal, Berazategui y todo el partido. Mas de 80 años de experiencia. Presupuesto sin cargo. Tel 4611-1818",
      ...
      <main className="pt-24 pb-20">
        <article className="container mx-auto px-4 max-w-3xl">
          ...
          <div className="prose prose-lg mt-8 font-body text-muted-foreground leading-relaxed space-y-6">
            <p>Quilmes es uno de los partidos mas grandes e importantes del sur del Gran Buenos Aires, con una gran variedad de barrios residenciales, zonas comerciales e industriales. En Marino Mudanzas realizamos mudanzas en Quilmes, Bernal, Berazategui y todas las localidades del partido con más de 80 años de experiencia.</p>
