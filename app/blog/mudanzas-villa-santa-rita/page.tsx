      ...
      <main className="pt-24 pb-20">
        <article className="container mx-auto px-4 max-w-3xl">
          ...
          <div className="prose prose-lg mt-8 font-body text-muted-foreground leading-relaxed space-y-6">
            ...
            <p>Villa Santa Rita tiene una fisonomía predominantemente horizontal con casas de familia, algunos edificios de 4 a 6 pisos y calles tranquilas con poco tráfico. Es un barrio donde las mudanzas se pueden organizar con comodidad gracias al amplio espacio disponible para los camiones.</p>
            <ul className="list-disc pl-6 space-y-2">
              <li>Predominio de casas bajas con jardín y accesos amplios</li>
              <li>Calles tranquilas con bajo tráfico — facilita la carga y descarga</li>
            ...
            <h2 className="font-display text-2xl font-bold text-foreground mt-10 mb-4">Contactanos para tu mudanza en Villa Santa Rita</h2>
